 ...
 * date : 2020.09.10
 * 1.1.1  
 * $('...').vcTabs('option', {startIndex : 2}); 옵션추가시 오프젝트도 받을수 있도록 수정.
...
;(function (global, undefined) {
    ...
    extend(core, {
         ...
         * @param {boolean} allowEmptyString 빈문자를 허용할 것인지 여부 default : false
         * @return {boolean}
         * @example
...
/////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    core.addon('number', /** @lends vcui.number */{
         ...
         *
         * @param {string} value 
         * @param {Number} size '000' 몇자리표현
         * @param {String} ch 기본값 '0'으로 채움
         * @return {string}
         * @example
...
// 네이티브에 f가 존재하지 않으면 false 반환
    ...
    core.addon('array', /** @lends vcui.array# */{
         ...
         * @return {*} 초기값
         * @see {@link https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce}
         * @example
...
;(function (core, global, undefined) {
    ...
    core.addon('object', /** @lends vcui.object */{
         ...
         * @param {string} tab 
         * @return {object}
         * @see {@link https://goessner.net/download/prj/jsonxml/}
         * @example
         * vcui.object.xml2json('<root><name>김두일</name></root>') // {"name":"김두일"}
         * 
         */
    ...
    */
    ...
    function classExtend(name, attr, parentClass) {
        ...
        */
         ...
         * @function
         * @name vcui.BaseClass.statics
         * @param o {object} statics 메소드 모음 객체
         * @example
         * var Parent = vcui.BaseClass.extend({});
         * Parent.statics({
         *     show: function(){
...
//
    ...
    var View = core.BaseClass.extend(/** @lends vcui.ui.View# */{
         ...
         * @return {*}
         * @example
         * $('...').vcTabs('option', 'startIndex', 2); // set
         * $('...').vcTabs('option', {startIndex : 2}); // set object
         * $('...').vcTabs('option', 'startIndex'); // get // 2
         */
...
;(function ($, core, context, undefined) {
     ...
     * @function
     * @name $#debounce
     * @param {function(event:Event, fn:Function, time:Number)} fn 콜백함수
     * @return {jQuery}
     */
