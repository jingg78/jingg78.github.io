...
vcui.define('ui/selectbox', ['jquery', 'vcui', 'helper/gesture'], function ($, core, Gesture) {
    ...
    var BaseSelectbox = core.ui.View.extend(/** @lends vcui.ui.Selectbox# */{
        name: 'Selectbox',
        templates: {
     ...
     * 커스텀 셀렉트박스
     */
    var CustomSelectbox = core.ui('CustomSelectbox', BaseSelectbox, /** @lends vcui.ui.Selectbox# */{
     ...
     * 픽커형식 셀렉트박스
     */
    var PickerSelectbox = core.ui('PickerSelectbox', BaseSelectbox, /** @lends vcui.ui.Selectbox# */{
    ...
    var CustomPickerSelectbox = core.ui('CustomPickerSelectbox', BaseSelectbox, /** @lends vcui.ui.Selectbox# */{
