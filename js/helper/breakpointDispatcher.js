 ...
 * @example
 * new vcui.helper.BreakpointDispatcher({
 *  matches: {
 *      '(min-width: 768px)' : function(mq) { // 미디어쿼리문
 *      }    
 *  }
 * }).start();  
 * 
...
vcui.define('helper/breakpointDispatcher', ['jquery', 'vcui'], function($, core) {
    ...
    var BreakpointDispatcher = core.helper('BreakpointDispatcher', vcui.BaseClass.extend(/** @lends  vcui.helper.BreakpointDispatcher */{
        $singleton: true,
